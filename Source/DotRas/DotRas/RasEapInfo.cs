...
namespace DotRas
{
    ...
    public sealed class RasEapInfo
    {
        ...
        private int _sizeOfEapData;
        private IntPtr _eapData;
        ...
        /// <summary>
        /// Gets or sets the size of the binary information pointed to by the <paramref name="RasEapInfo.EapData"/> property.
        /// </summary>
        public int SizeOfEapData
        {
            get { return this._sizeOfEapData; }
            set { this._sizeOfEapData = value; }
        }
