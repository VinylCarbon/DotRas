...
namespace DotRas
{
    ...
    internal static class ThrowHelper
    {
        ...
        {
            ThrowHelper.ThrowArgumentException(argumentName, resource, new object[0]);
        }
        ...
        public static void ThrowArgumentException(string argumentName, string resource, params object[] args)
        {
            ...
            argsList.Insert(0, argumentName);

            throw new ArgumentException(ThrowHelper.FormatResourceString(resource, argsList.ToArray()), argumentName);
        }
