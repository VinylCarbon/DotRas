...
namespace DotRas
{
    ...
    public sealed class RasDevice
    {
        ...
        /// <exception cref="System.ArgumentException"><paramref name="name"/> or <paramref name="deviceType"/> is an empty string or null reference (<b>Nothing</b> in Visual Basic).</exception>
